...
saveToStorage() {
  localStorage.setItem(this.#localStorageKey, JSON.stringify(this.cartItems)); //using JSON stringify because localstorage takes strings
}
...
/* Instead of this we have used constructor function in the class.
